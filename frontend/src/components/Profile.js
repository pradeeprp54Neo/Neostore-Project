...
import {
  ...
  Row,
  Col,
  ListGroup,                            //It will show the user details whichever he is registered and we can edit the details as well.
  Image,
        ...
        <Col className="col-8">
          ...
          <Col className="col-4">
            <Col className="p-3 m-auto" style={{ display: "block" }}>
              <Image height="200" width="200" src="../images/p1.jpg" roundedCircle />
            </Col>
